    ...
    return (
        <div className="my-10">
           <div className="flex justify-between">
                ...
                <p className={`mr-16 text-lg font-bold rounded-full ${subsumcredit >= subleastcredit ? "text-lime-500" : "text-red-400"}`}>{ subsumcredit && subleastcredit ? `จำนวนหน่วยกิตรวม ${subsumcredit} >= ${subleastcredit} หน่วยกิต` : ""}</p>
            </div>
